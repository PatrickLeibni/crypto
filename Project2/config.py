...
PATHS = {
    ...
    "watermarked_image": DATA_DIR / "watermarked_image.jpg",
    "comparison_image": DATA_DIR / "watermark_comparison.png",
    "robustness_report": RESULTS_DIR / "robustness_report.txt",
    "robustness_plot": RESULTS_DIR / "robustness_plot.png",
}
...
LOGGING_CONFIG = {
    ...
    "handlers": {
        ...
        "file": {
            ...
            "filename": RESULTS_DIR / "watermark.log",
            "mode": "a",
        },
    },
    "loggers": {
