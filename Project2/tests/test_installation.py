...
def test_imports():
    ...
    try:
        ...
        assert False, f"Matplotlib 导入失败: {e}"
    ...
    try:
        ...
        print(f"✗ 标准库导入失败: {e}")
        assert False, f"标准库导入失败: {e}"

    # 所有导入成功，无需返回值或使用assert True
